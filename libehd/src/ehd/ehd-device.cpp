...
Device::Device(v4l2::Device *device) :
    _device(device) {
        v4l2::Camera *h264Camera = device->find_camera_with_format(V4L2_PIX_FMT_H264);
        _options.insert(std::make_pair("bitrate", new xu::Option(h264Camera, xu::USR_ID, xu::USR_H264_CTRL, xu::H264_BITRATE_CTRL)));
        _options.insert(std::make_pair("gop",     new xu::Option(h264Camera, xu::USR_ID, xu::USR_H264_CTRL, xu::GOP_CTRL)));
