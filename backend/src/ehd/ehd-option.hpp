...
namespace libehd {
    ...
    namespace xu {
        ...
        public:
             ...
             */
            Option(v4l2::Camera *camera, xu::Unit unit, xu::Selector ctrl, xu::Command id, uint8_t size=11);
             ...
             * @param byte_order byte order of packed value (EX: LITTLE_ENDIAN, BIG_ENDIAN)
             */
            template<typename T>
             ...
             * @param byte_order byte order of unpacked value (EX: LITTLE_ENDIAN, BIG_ENDIAN)
