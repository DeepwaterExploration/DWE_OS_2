...
class Server:
    ...
    def __init__(self, settings_path: str, feature_support: FeatureSupport, port=8080) -> None:
        ...
        # Lights and PWM
        # self.pwm_manager = GlobalPWMManager(self.pin_state_storage, device_family=DeviceFamily.SERIAL, model='SerialPWMController')
        self.pwm_manager = SerialPWMManager('/dev/ttyUSB0', self.pin_state_storage)
